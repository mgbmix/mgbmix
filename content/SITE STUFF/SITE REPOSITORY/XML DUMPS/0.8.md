XML file version 0.8 was published 2023-11-02
...
> Second version containing Drop02 cards. Many are in a rough state and will require improvement.
...
<set>
  <name>T</name>
  <longname>Mondo Megabits: Tokens</longname>
  <settype>Custom</settype>
  <releasedate>2023-11-01</releasedate>
</set>
<set>
  <name>D01</name>
...
<card>
  <name>Monkey Kong Krusade</name>
  <text>(To play this card, opponent must have at least one (1) Monkey-type creature deployed) Monkey Kong Crusade: 
    An organized platoon of monkey super soldiers has you in its sights. They have proper trigger discipline and good posture. 
    There's no evading the onslaught of monkeys about to turn your scrotum into confetti. 
    Give up now and they might let you join their ranks.
♦ Select one (1) non-monkey-type creature to pretend to surrender to the opponent’s monkey army;   
send it over across the battle lines. Henceforth your double agent will be known as codename: Jerome.  
♦ Roll a D6. If anything other than 1: opponent’s monkey army accepts the double-agent as one of their own.  
Jerome becomes a basic infantryman in the monkey corps.  
If 1: the rival monkeys intuit Jerome’s true intentions and put it to death (creature is destroyed).  
...
♦ Decade 7: Jerome’s mastermind plan: capture and infect the opponent’s schools, churches, intelligentsia, literature, pop culture, and incrementally bend them away from the opponent’s ideology and towards that of the player. For so long this plan seemed futile, preposterous, but now it has yielded some fruit. Smile, comrade, for today you take the reins of the most powerful force the world has ever seen-the Grand Monkey Army! (All non-robot enemy creatures currently in play switch to your side.)
  ...
  <set rarity="token" uuid="" num="1" muid="" picurl="">T</set>
   <reverse-related>Monkey Terrorists</reverse-related>
  <token>1</token>
  <tablerow>2</tablerow>
</card>
...
<card>
  <name>Jack</name>
<text>
HP: 750 STR: 0 INT: 10 FYT: 0 NRG: 5 SWG: 6 PSI: 0

/Lost in the Sauce/  
When either Vyco (Jack) OR [D.I.N.] (Jill) uses a Drug item, they both enjoy the effects, and for double (2x) the duration.

/Jack In, Plug Out/ 
If Jack and Jill do not both consume a Drug Item at least once every (5) turns, destroy them.
...
<prop> 
      ...
      <type>Creature - Nemesis</type>
      <Rarity>T</Rarity>
      <FundingCost>0</FundingCost>
      <manacost>0</manacost>
      <pt>HP: 750 STR: 0 INT: 10 FYT: 0 NRG: 5 SWG: 6 PSI: 0</pt>
      <HP>750</HP>
      <STR>0</STR>
      <INT>10</INT>
      <FYT>0</FYT>
  ...
  <set rarity="token" uuid="" num="2" muid="" picurl="">T</set>
  <reverse-related>Jack Jill Vyco and DIN</reverse-related>
  <token>1</token>
  <tablerow>2</tablerow>
</card>
...
<prop> 
  ...
  <set rarity="token" uuid="" num="3" muid="" picurl="">T</set>
  <reverse-related>Jack Jill Vyco and DIN</reverse-related>
  <token>1</token>
  <tablerow>2</tablerow>
</card>   
 <card>
  <name>Think Tank Token</name>
  <text>THINK TANK TOKEN

Use this token for attaching cards to your think tank game area.  
      
Each player should have their own copy of this token as needed.  
...
Used for attaching:  
  ...
  <prop>
    <type>Token - Game Area</type>
         <colors>Token</colors>
    <maintype>Token</maintype>
  </prop>
  <set rarity="token" uuid="" num="4" muid="" picurl="">T</set>
  <reverse-related>Wireless Vaccine+-</reverse-related>
  <reverse-related>Time Cube</reverse-related>   
  <reverse-related>Teleport Tracker</reverse-related>   
  <reverse-related>Inscribe and Requite</reverse-related>  
  <reverse-related>Monkey Kong Krusade</reverse-related>   
  <reverse-related>Credible Threat Generator</reverse-related>  
  <reverse-related>FunVax</reverse-related> 
   <token>1</token>
  <tablerow>0</tablerow>
</card>   
    
 <card>
  <name>Active Zone Token</name>
  <text>ACTIVE ZONE TOKEN

Use this token for attaching cards to your active zone game area.  
...
Used for attaching:  
  ...
  <set rarity="token" uuid="" num="5" muid="" picurl="">T</set>
  <reverse-related>Camera Loop</reverse-related>
  <reverse-related>Busted Pharmaceutical Kiosk</reverse-related>  
  <reverse-related>Survival Arts</reverse-related>     
  <reverse-related>Ditch Contraband</reverse-related>       
   <token>1</token>
  <tablerow>1</tablerow>
</card>       
...
If you do, create a Skill - Spy Arts token called Monkey Kong Krusade already equipped to your Think Tank.
</text>
<prop> 
      <Faction>FEMACUBE³</Faction>
     <colors>FEMACUBE³</colors>
...
Whichever player(s) rolled the lowest value must sacrifice their selected Creature.  
If all players rolled the same value, no creature is sacrificed.  
